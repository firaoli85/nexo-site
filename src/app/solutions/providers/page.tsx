...
const SECTIONS: SolutionSection[] = [
  {
    ...
    proofs: [
      ...
      { icon: BadgeCheck, text: "Approval before any assignment, with no surprises at dispatch." },
  ...
  },
  {
    ...
    proofs: [
      ...
      { icon: ListChecks, text: "Claims are scrubbed and checked before submission, not just sent." },
